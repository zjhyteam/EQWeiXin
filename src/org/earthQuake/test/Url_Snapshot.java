...
public class Url_Snapshot extends JPanel {
	/**
	 * 
	 */
	...
	public Url_Snapshot(final String url, final int maxWidth, final int maxHeight) {
...
//						image = op.filter(image, null);
					...
					try {
						// 输出图像
						ImageIO.write(image, "jpg", new File("E:/image/" + fileName));
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							...
							frame.getContentPane().add(
									new Url_Snapshot("http://qq370273662.oicp.net/EQWeiXin/map/map.jsp?lat=21.73488&lon=112.29717", 1300, 900),
									BorderLayout.CENTER);
